...
#include "BboundaryFvPatchVectorField.H"
...
Foam::BboundaryFvPatchVectorField::BboundaryFvPatchVectorField
(
    const fvPatch& p,
...
Foam::BboundaryFvPatchVectorField::BboundaryFvPatchVectorField
(
    const BboundaryFvPatchVectorField& ptf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
Foam::BboundaryFvPatchVectorField::BboundaryFvPatchVectorField
(
    const BboundaryFvPatchVectorField& wbppsf
)
:
...
void Foam::BboundaryFvPatchVectorField::updateCoeffs
(
...
void Foam::BboundaryFvPatchVectorField::write(Ostream& os) const
{
